 ...
 */
public abstract class AbstractAFSKDecoder extends Decoder implements IReusableBufferListener, Listener<ReusableDoubleBuffer>
{
    ...
    {
        mAFSK1200Decoder.receive(reusableDoubleBuffer);
    }

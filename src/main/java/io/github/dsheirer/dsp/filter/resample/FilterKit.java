...
public class FilterKit {
     ...
     * @return
     */
    public static double lrsFilterUp(double Imp[], double ImpD[], int Nwing, boolean Interp, double[] Xp_array, int Xp_index, double Ph,
            int Inc) {
        double a = 0;
        double v, t;
        ...
        v = 0.0d; // The output value

        double[] Hp_array = Imp;
        int Hp_index = (int) Ph;

        double[] End_array = Imp;
        int End_index = Nwing;

        double[] Hdp_array = ImpD;
     ...
     * @return
     */
    public static double lrsFilterUD(double Imp[], double ImpD[], int Nwing, boolean Interp, double[] Xp_array, int Xp_index, double Ph,
            int Inc, double dhb) {
        double a;
        double v, t;
        double Ho;
        ...
        if (Interp) {
            ...
            while ((Hp_index = (int) Ho) < End_index) {
                ...
                a = Ho - Math.floor(Ho); // a is logically between 0
                                                   // and 1
                t += Hdp_array[Hdp_index] * a; // t is now interp'd filter coeff
                t *= Xp_array[Xp_index]; // Mult coeff by input sample
                v += t; // The filter output
